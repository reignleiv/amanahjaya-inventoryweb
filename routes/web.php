...
Route::group(['middleware' => 'userlogin'], function () {
    ...
    Route::middleware(['checkRoleUser:/supplier,menu'])->group(function () {
        // Customer
        Route::resource('/admin/supplier', \App\Http\Controllers\Admin\CustomerController::class);
        Route::get('/admin/supplier/show/', [CustomerController::class, 'show'])->name('customer.getcustomer');
        Route::post('/admin/supplier/proses_tambah/', [CustomerController::class, 'proses_tambah'])->name('customer.store');
        Route::post('/admin/supplier/proses_ubah/{customer}', [CustomerController::class, 'proses_ubah']);
        Route::post('/admin/supplier/proses_hapus/{customer}', [CustomerController::class, 'proses_hapus']);
    });
    ...
    Route::middleware(['checkRoleUser:/lap-barang-masuk,submenu'])->group(function () {
        ...
        Route::get('/admin/lapbarangmasuk/excel/', [LapBarangMasukController::class, 'excel'])->name('lap-bm.xlsx');
    ...
    Route::middleware(['checkRoleUser:/lap-barang-keluar,submenu'])->group(function () {
        ...
        Route::get('/admin/lapbarangkeluar/excel/', [LapBarangKeluarController::class, 'excel'])->name('lap-bk.xlsx');
    ...
    Route::middleware(['checkRoleUser:/lap-stok-barang,submenu'])->group(function () {
        ...
        Route::get('/admin/lapstokbarang/excel/', [LapStokBarangController::class, 'excel'])->name('lap-sb.xlsx');
